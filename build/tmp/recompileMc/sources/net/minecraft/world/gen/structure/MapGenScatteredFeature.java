...
public class MapGenScatteredFeature extends MapGenStructure
{
    ...
    private final List<Biome.SpawnListEntry> enemies;
    ...
    {
        this.enemies = Lists.<Biome.SpawnListEntry>newArrayList();
        this.maxDistanceBetweenScatteredFeatures = 32;
        this.minDistanceBetweenScatteredFeatures = 8;
        this.enemies.add(new Biome.SpawnListEntry(EntityWitch.class, 1, 1, 1));
    }
     ...
     */
    public List<Biome.SpawnListEntry> getEnemies()
    {
        return this.enemies;
    }
